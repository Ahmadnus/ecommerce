...
'view_all_arrow'    => 'عرض الكل ←',
    ...
    'home_intro_title'       => 'مصمم لأسلوب حياتك اليومي',
    'home_intro_text'        => 'اكتشف مجموعة مختارة بعناية من القطع المصممة بجودة وراحة وأناقة خالدة.',
    'home_divider1_title'    => 'مجموعة الأساسيات',
    'home_divider1_text'     => 'قطع أساسية مختارة بعناية تتناسب مع خزانتك، مصنوعة لتدوم ولترتديها بثقة.',
    'home_divider1_btn'      => 'تسوق المجموعة',
    'home_divider2_title'    => 'وصل حديثاً',
    'home_divider2_text'     => 'تصاميم جديدة تُضاف باستمرار — كن أول من يكتشف ما وصل حديثاً إلى المعرض.',
    'home_divider2_btn'      => 'اكتشف الجديد',
    'home_footer_title'      => 'ارتقِ بأسلوبك اليومي',
    'home_footer_text'       => 'انضم إلى آلاف العملاء الذين يثقون بنا للحصول على قطع عالية الجودة تدوم طويلاً.',
    'home_footer_btn'        => 'ابدأ التسوق',
...
'all_categories' => 'الكل',
 'order_success' => [
    ...
    'checkout' => [
        'field_phone_ph' => 'رقم الهاتف',
        'phone_select_country_first' => 'يرجى اختيار الدولة أولاً',
...
'auth' => [
    ...
    'forgot_password_subtitle' => 'سنرسل لك رابط إعادة التعيين على بريدك',
    'forgot_password_heading' => 'نسيت كلمة المرور؟',
    'forgot_password_desc' => 'أدخل البريد الإلكتروني المرتبط بحسابك وسنرسل لك رابطاً لتعيين كلمة مرور جديدة.',
...
'continue_shopping' => 'مواصلة التسوق',
'remove' => 'إزالة',
'no_products_text' => 'جرّب كلمة بحث أخرى أو تصفّح قسماً مختلفاً.',
'cart_empty_text' => 'تصفّح المتجر وأضف المنتجات التي تعجبك.',
'currency' => 'العملة',
'items' => 'منتج',
'customize' => 'التصميم',
'quantity' => 'الكمية',
