{{--
    ╔══════════════════════════════════════════════════════╗
    ║  PRICE & CART VISIBILITY TOGGLE                      ║
    ║  Include this in your <head> (layouts/app.blade.php) ║
    ║  via:  @include('partials.hide-price-cart')          ║
    ║                                                      ║
    ║  To re-enable everything, just remove this include.  ║
    ╚══════════════════════════════════════════════════════╝
--}}
<style>
