            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="identity" value="{{ old('identity') }}" required
                               placeholder="{{ __('app.auth.login.email_placeholder') }}" dir="ltr"
                               class="input-field w-full bg-gray-50 border @error('identity') border-red-400 @else border-gray-200 @enderror
                                      rounded-xl px-4 pe-10 py-3 text-sm text-left focus:outline-none focus:ring-2"
                               style="--tw-ring-color:var(--brand-color,#0ea5e9)">
                    </div>
                    @error('identity')<p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>@enderror
                </div>
                ...
                <div>
                  ...
                  <a href="{{ route('password.request') }}" class="text-xs font-bold hover:underline" style="color:var(--brand-color,#0ea5e9)">{{ __('app.auth.login.forgot_password') }}</a>
                    </div>
                    <div class="relative">
