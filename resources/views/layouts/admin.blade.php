...
<body class="text-black" style="background:#ffffff; color:#000000;">
    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: true }">
        ...
        {{-- Sidebar --}}
        <aside style="background:#000000; color:#ffffff;" class="transition-all duration-300 flex-shrink-0 flex flex-col h-screen" 
           :class="sidebarOpen ? 'w-64' : 'w-20'">
        
            {{-- 1. الجزء الثابت: الهيدر --}}
            <div class="p-4 flex items-center justify-between flex-shrink-0" style="border-bottom:1px solid rgba(255,255,255,0.12);">
                <span x-show="sidebarOpen" class="font-bold text-lg tracking-wider truncate" style="color:#ffffff;">لوحة التحكم</span>
                <button @click="sidebarOpen = !sidebarOpen" class="p-1 rounded transition-colors" style="color:#ffffff;" onmouseover="this.style.background='rgba(255,255,255,0.1)'" onmouseout="this.style.background='transparent'">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar px-2 py-4">
                ...
                @can('manage-catalog')
                    ...
                    <div x-show="sidebarOpen" class="px-3 mt-4 mb-2 text-[10px] font-bold uppercase tracking-wider" style="color:rgba(255,255,255,0.4);">
                        محتوى المتجر
                    </div>
                ...
                @can('manage-all')
                    <div x-show="sidebarOpen" class="px-3 mt-6 mb-2 text-[10px] font-bold uppercase tracking-wider" style="color:rgba(255,255,255,0.4);">
                        المبيعات والعملاء
                    </div>
                    ...
                    <x-admin-nav-link href="{{ route('admin.orders.index') }}" icon="shopping-cart" :active="request()->routeIs('admin.orders.*')">
                        ...
                        @if($pendingCount > 0)
                            <span x-show="sidebarOpen" class="mr-auto text-[10px] px-1.5 py-0.5 rounded-full animate-pulse" style="background:#ef4444; color:#ffffff;">
                                {{ $pendingCount }}
                            </span>
                        @endif
                    </x-admin-nav-link>
            ...
            <div class="p-2 flex-shrink-0" style="border-top:1px solid rgba(255,255,255,0.12); background:#000000;">
        ...
        <div class="flex-1 flex flex-col overflow-hidden" style="background:#ffffff;">
            {{-- Header --}}
            <header class="h-16 flex items-center justify-between px-8" style="background:#ffffff; border-bottom:1px solid #e5e7eb;">
                <div class="text-sm font-bold uppercase tracking-wide" style="color:#000000;">
                    @yield('title')
                </div>
                <div class="flex items-center gap-4">
                    <a href="/" target="_blank" class="text-xs font-bold transition-colors flex items-center gap-1" style="color:#6b7280;" onmouseover="this.style.color='var(--brand-color)'" onmouseout="this.style.color='#6b7280'">
                    ...
                    <div class="h-8 w-8 rounded-full bg-brand flex items-center justify-center text-xs font-bold" style="background:#000000; color:#ffffff;">
            ...
            <main class="flex-1 overflow-y-auto p-8" style="background:#f9fafb;">
                ...
                @if(session('success'))
                    <div x-data="{ show: true }" x-show="show" x-transition 
                         class="mb-6 p-4 rounded-xl flex justify-between items-center" style="background:#f0fdf4; color:#166534; border:1px solid #bbf7d0;">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" style="color:#16a34a;"><path d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"></path></svg>
