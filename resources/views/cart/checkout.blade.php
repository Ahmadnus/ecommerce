            ...
            <div class="u2 bg-white rounded-2xl border border-[#ece9e4] overflow-hidden">
                ...
                <div class="divide-y divide-[#f7f6f3]">
                    ...
                    <div class="cart-row flex items-center gap-4 px-5 py-4">
                        ...
                        {{-- Image with skeleton --}}
                        <div class="relative w-16 h-16 rounded-xl overflow-hidden bg-[#f7f6f3] flex-shrink-0 border border-[#f0ede8]">
                            <div class="sk absolute inset-0" id="sk-img-{{ $loop->index }}"></div>
                            <img src="{{ $item['image'] ?? 'https://picsum.photos/seed/'.$loop->index.'/120/120' }}"
                                 alt="{{ $item['name'] }}"
                                 class="w-full h-full object-cover relative z-10"
                                 onload="document.getElementById('sk-img-{{ $loop->index }}').style.display='none'">
                        </div>
            ...
            <div class="u3 bg-white rounded-2xl border border-[#ece9e4] overflow-hidden">
                ...
                <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-semibold text-[#6b6966] mb-2 tracking-wide uppercase">
                    ...
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-semibold text-[#6b6966] mb-2 tracking-wide uppercase">
                            عنوان التوصيل <span class="text-red-400 normal-case">*</span>
                        </label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-[#6b6966] mb-2 tracking-wide uppercase">
                            الرمز البريدي
                            <span class="text-[#b5b2ab] normal-case font-normal">اختياري</span>
                        </label>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="notes" rows="2"
                                  ...
                                  class="field resize-none">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="u4 bg-white rounded-2xl border border-[#ece9e4] overflow-hidden">
                ...
                <div class="p-5">
                    <label class="flex items-center gap-4 p-4 border-2 border-[#1a1917] rounded-xl cursor-pointer bg-[#faf9f7]">
                        ...
                        <span class="mr-auto text-[10px] font-bold bg-[#1a1917] text-white px-2 py-1 rounded-lg tracking-wide">
                            متاح
                        </span>
                    </label>
                </div>
                ...
                <div class="p-5">
                    ...
                    <div class="space-y-3 mb-5">
                        ...
                        <div class="flex items-start gap-3">
                            <div class="w-9 h-9 rounded-lg overflow-hidden bg-[#f7f6f3] border border-[#f0ede8] flex-shrink-0">
                                <img src="{{ $item['image'] ?? 'https://picsum.photos/seed/'.($loop->index+10).'/80/80' }}"
                    ...
                    <div class="space-y-2.5 text-xs border-t border-[#f0ede8] pt-4 mb-4">
                        <div class="flex justify-between">
                            <span class="text-[#9a9793]">المجموع الفرعي</span>
                            <span class="font-semibold text-[#1a1917] tabular-nums">
                                ${{ number_format($summary['subtotal'], 2) }}
                            </span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-[#9a9793]">الضريبة (10%)</span>
                            <span class="font-semibold text-[#1a1917] tabular-nums">
                                ${{ number_format($summary['tax'], 2) }}
                            </span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-[#9a9793]">الشحن</span>
                    ...
                    <button type="submit" id="place-btn"
                            class="w-full py-4 rounded-xl bg-[#1a1917] hover:bg-[#2d2c2a] text-white
                                   ...
                                   flex items-center justify-center gap-2 shadow-lg shadow-black/15
                                   active:scale-[.98]">
                    ...
                    <div class="secure-row mt-4">
                        ...
                        دفع آمن ومشفر • جميع المعاملات محمية
                    </div>
