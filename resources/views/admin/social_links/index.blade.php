    ...
    <form action="{{ route('admin.social-links.store') }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="flex items-center gap-2 mt-auto mb-4">
                ...
                <label for="is_floating" class="text-sm font-bold text-gray-700 select-none cursor-pointer">
                    تفعيل كـ زر عائم
                </label>
            </div>
        </div>
        ...
        <button type="submit"
                class="mt-4 bg-blue-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-200">
            حفظ الرابط
        </button>
    </form>
