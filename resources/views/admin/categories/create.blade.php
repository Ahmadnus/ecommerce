                ...
                <div class="flex items-center gap-6">
                    <div class="relative flex-shrink-0">
                        <div class="w-20 h-20 rounded-full overflow-hidden border-2 border-dashed
                             ...
                             id="preview-ring">
                            <img id="img-preview"
                                 src="{{ asset('images/placeholder-category.png') }}"
                                 class="w-full h-full object-cover hidden rounded-full"
                                 alt="معاينة">
                            <svg id="img-placeholder" class="w-8 h-8 text-gray-300"
            ...
            <div>
                ...
                <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" min="0"
                       class="w-32 border border-gray-200 rounded-xl focus:ring-2
                              focus:ring-brand/30 focus:border-brand p-3 bg-gray-50 transition">
                <p class="text-xs text-gray-400 mt-1">رقم أصغر = يظهر أولاً</p>
            </div>
