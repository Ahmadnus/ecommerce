    ...
    <form action="{{ route('admin.categories.update', $category->id) }}"
        ...
        <div class="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm space-y-6">
            ...
            <div>
                ...
                <input type="text" name="slug" id="slug-input"
                       ...
                       class="w-full border border-gray-200 rounded-xl focus:ring-2
                              focus:ring-brand/30 focus:border-brand p-3 bg-gray-50 font-mono text-sm transition">
            </div>
            ...
            <div>
                ...
                <input type="number" name="sort_order"
                       ...
                       class="w-32 border border-gray-200 rounded-xl p-3 bg-gray-50 transition">
            </div>
            ...
            <div class="border-t border-gray-100 pt-6 mt-2">
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative rounded-xl overflow-hidden border border-gray-200 group">
                        <img src="{{ $currentBannerUrl }}" alt="البانر الحالي"
                             class="w-full h-32 object-cover">
                        <div class="absolute inset-0 bg-black/0 group-hover:bg-black/20
                                    transition-colors flex items-center justify-center">
                            <span class="opacity-0 group-hover:opacity-100 transition-opacity
                                         text-white text-xs font-bold bg-black/50 px-3 py-1 rounded-full">
                                البانر الحالي
                            </span>
                        </div>
                    </div>
                    <label class="flex items-center gap-2 text-xs font-semibold text-red-500 cursor-pointer w-fit">
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-3">
                <a href="{{ route('admin.categories.index') }}"
                   class="px-6 py-3 text-gray-500 font-bold hover:text-red-500 transition text-sm">إلغاء</a>
                <button type="submit"
                        class="bg-brand text-white px-10 py-3 rounded-xl font-bold shadow-lg hover:bg-brand/90 hover:scale-[1.02] transition-transform active:scale-95">
                    حفظ التعديلات
                </button>
            </div>
        </div>
