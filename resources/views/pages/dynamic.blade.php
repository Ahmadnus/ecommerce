...
@php
    ...
    $featuredImage = $page->getFirstMedia('featured');
    $featuredImageUrl = $featuredImage?->getUrl();
    $featuredImageAlt = $featuredImage?->getCustomProperty('alt')
                        ?: $pageName;
@endphp
...
[dir="rtl"] .page-featured figcaption { font-family: var(--font-ar); }
[dir="ltr"] .page-featured figcaption { font-family: var(--font-en); }
    ...
    @if($featuredImageUrl)
        <section class="page-featured">
            <figure>
                ...
                @if($featuredImageAlt)
                    <figcaption>{{ $featuredImageAlt }}</figcaption>
                @endif
            </figure>
        </section>
    @endif
